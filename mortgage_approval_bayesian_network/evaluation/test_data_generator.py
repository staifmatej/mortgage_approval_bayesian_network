...
class TestDataGenerator:
    ...
    def generate_stress_test_data(self, num_records=100000, scenario="economic_downturn"):
        ...
        print(f"  Training params: salary={self.base_avg_salary:,.0f}, rate={self.base_interest_rate:.3f}")
        print(f"  Test params: salary={test_avg_salary:,.0f}, rate={test_interest_rate:.3f}")
    ...
    def generate_multiple_scenarios(self, num_records=3000):
        ...
        for scenario in scenarios:
            csv_path, params = self.generate_stress_test_data(num_records, scenario)
            results[scenario] = {
                'csv_path': csv_path,
                'parameters': params
            }
...
if __name__ == "__main__":
    ...
    csv_path, params = generator.generate_stress_test_data(5000, "economic_downturn")
